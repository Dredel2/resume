  ...
  res.render('summary', {
    ...
    main: {
      summary: {
        ...
        on a new project I learn the domain and try to understand the idea of the project. Good team player, every colleague 
        is a friend to me.`,
      },
...
router.get('/education', function (req, res) {
  ...
  res.render('education', {
    ...
    main: {
      ...
      education: [
        {
          name: 'NATIONAL UNIVERSITY OF WATER MANAGEMENT AND NATURAL USE',
          isEnd: true,
        },
        {
          name: 'IT-Brains',
        ...
        {
          name: 'General education school grades 1-3',
          isEnd: true,
        },
      ],
          ...
          projects: [
            {
              ...
              about: 'Information about project Resume',
              stacks: [
                {
                  name: 'React.js',
                },
